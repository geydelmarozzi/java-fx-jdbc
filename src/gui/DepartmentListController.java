...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		//Chamadas Padrão para inicializar as colunas vinculando aos atributos da Classe Department
		tableColumnId.setCellValueFactory(new PropertyValueFactory<>("id"));
		tableColumnName.setCellValueFactory(new PropertyValueFactory<>("name"));
		
		//Ajusta o posicionamento da TableView para ocupar toda a área da tela.
	...
	private void initEditButtons() {
		//Adiciona o botão de edição em cada linha da tabela. Ao clicar no botão abre o PoupUp pra Edição! 
